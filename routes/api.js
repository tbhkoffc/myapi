...
const listkey = ["hurvy", "trial", "jayagans"];
...
router.get('/addapikey', (req, res, next) => {
    ...
    if (apikey != 'Vinza') return res.sendFile(__path + '/views/eror.html')
...
router.get('/cewe/vietnam', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Vinza')  return res.sendFile(__path + '/views/eror.html')
...
router.get('/randomquote', async (req, res, next) => {
	...
	if(apikeyInput != 'Vinza') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Vinz/database-api/main/fun/quote.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/caklontong', async (req, res, next) => {
	...
	if(apikeyInput != 'Vinza') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Vinz/database-api/main/fun/caklontong.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/kuis/tebakgambar', async (req, res, next) => {
	...
	if(apikeyInput != 'Vinza') return res.sendFile(__path + '/views/eror.html')
       ...
       fetch(encodeURI(`https://raw.githubusercontent.com/Vinz/database-api/main/fun/tebakgambar.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/darkjokes', async (req, res, next) => {
        var apikeyInput = req.query.apikey
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Vinza')  return res.json(invalidKeynya)
       fetch(encodeURI(`https://raw.githubusercontent.com/Vinz/database-api/main/meme/darkjokes.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
